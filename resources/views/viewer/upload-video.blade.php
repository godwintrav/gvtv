      ...
      <div id="wrapper">
         ...
         <div id="content-wrapper">
            <div class="container-fluid upload-details">
               <form action="/set_upload_video" method="post">
               <div class="row">
                  <div class="col-lg-12">
                  ...
                  <div class="col-lg-10">
                     <div class="osahan-title">Enter details for Video</div>
                   </div>
               </div>
               <hr>
               <div class="row">
                        ...
                        <div class="row">
                           <div class="col-lg-5">
                              <div class="form-group">
                                 ...
                                 <input required type="text" placeholder="Gaming, PS4" name="tags" id="e7" class="form-control" style="width: 1080px;">
                              </div>
                              @error('tags')
                                 <span >
                                 <p style="color: red;">{{ $message }}</p>
