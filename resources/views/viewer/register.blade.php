               ...
               <div class="col-md-5 p-5 bg-white full-height">
                  <div class="login-main-left">
                     ...
                     <form action="/register_viewer" method="post">
                        ...
                        <div class="form-group">
                           <label>Country</label>
                           <input required type="text" class="form-control" placeholder="Enter Country" name="country">
                        </div>
                        @error('country')
                           <span >
                            <p style="color: red;">{{ $message }}</p>
                        ...
                        <div class="form-group">
                           ...
                           <input required type="date" class="form-control" placeholder="Enter date of birth" name="dob">
                        </div>
                        @error('dob')
                           <span >
                            <p style="color: red;">{{ $message }}</p>
                     ...
                     <div class="text-center mt-5">
                        <p class="light-gray">Already have an Account? <a href="/viewer_login">Sign In</a></p>
                     </div>
                  </div>
               </div>
               <div class="col-md-7">
                  <div style="display: none;" class="login-main-right bg-white p-5 mt-5 mb-5">
                     <div class="owl-carousel owl-carousel-login">
                        <div class="item">
                           <div class="carousel-login-card text-center">
                              <img src="admin/img/login.png" class="img-fluid" alt="LOGO">
