...
<head>
   ...
   <nav class="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
         ...
         <!-- Navbar Search -->
         <form method="post" action="/viewer/search" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-5 my-2 my-md-0 osahan-navbar-search">
      ...
      <div id="wrapper">
         ...
         <ul class="sidebar navbar-nav">
            <li class="nav-item @yield('index')">
               <a class="nav-link" href="/viewer/index">
               <i class="fas fa-fw fa-home"></i>
               <span>Home</span>
               </a>
            </li>
            <li class="nav-item @yield('playlist')">
               <a class="nav-link" href="/viewer/playlist">
            ...
            <li class="nav-item">
               <a class="nav-link" href="/viewer/logout">
